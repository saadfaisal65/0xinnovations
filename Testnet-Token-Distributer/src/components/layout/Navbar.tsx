...
export default function Navbar() {
    ...
    const navLinks = [
        ...
        { name: "Nexus Faucet", href: "/faucet", icon: <Droplet className="w-5 h-5" /> },
        { name: "DeFi Dashboard", href: "/defi-dashboard", icon: <LayoutDashboard className="w-5 h-5" /> },
        { name: "Token Exchange", href: "/token-exchange", icon: <Coins className="w-5 h-5" /> },
        { name: "Smart Contracts", href: "/smart-contracts", icon: <Code className="w-5 h-5" /> },
    ];
